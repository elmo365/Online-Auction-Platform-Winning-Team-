...
function updateUser($user_id) {
  global $conn, $errors, $username, $firstname, $surname, $role_id, $email, $omang, $isEditing;
  ...
  if (count($errors) === 0) {
    ...
    $sql = "UPDATE users SET username=?, firstname=?, surname=?, role_id=?, email=?, password=?, omang_passport=?, profile_picture=? WHERE id=?";
    $result = modifyRecord($sql, 'sssissssi', [$username, $firstname, $surname, $role_id, $email, $password, $omang, $profile_picture, $user_id]);
...
function saveUser(){
  global $conn, $errors, $username, $role_id, $firstname, $surname, $email, $omang, $isEditing;
  ...
  if (count($errors) === 0) {
    ...
    $sql = "INSERT INTO users SET username=?, firstname=?, surname=?, role_id=?, email=?, password=?, omang_passport=?, profile_picture=?";
    $result = modifyRecord($sql, 'sssissss', [$username, $firstname, $surname, $role_id, $email, $password, $omang, $profile_picture]);
