          ...
          <form class="form" action="userForm.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo isset($errors['role_id']) ? 'has-error' : '' ?>">
              ...
              <?php endif; ?>
                ...
                <!-- Omang -->
            <div class="form-group <?php echo isset($errors['omang']) ? 'has-error' : '' ?>">
              <label class="control-label">Omang</label>
              <input type="text" name="omang" value="<?php echo $omang; ?>" class="form-control">
